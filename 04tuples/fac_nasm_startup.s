...
extern camlFac__entry
extern camlFac__data_begin
extern camlFac__data_end
extern camlFac__code_begin
extern camlFac__code_end
extern camlFac__gc_roots
...
caml_program:
        sub rsp, 8
L126:
        ;call    camlFac__entry@PLT
        call    camlFac__entry  ; Is it OK???
L127:
...
caml_data_segments:
        ...
        dq camlFac__data_begin
        dq camlFac__data_end
        dq 0
...
caml_code_segments:
        ...
        dq camlFac__code_begin
        dq camlFac__code_end
        dq 0
...
caml_frametable:
        ...
        ;.quad  camlFac__frametable
        ;dq camlFac__frametable
        dq 0
